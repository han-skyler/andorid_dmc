...
public class TestEva extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_eva);

        ////////// 전체 인덱스 불러오기 및 저장 //////////
        Intent intent = getIntent();

        int score = intent.getIntExtra("score",0);
        int totalIdx = intent.getIntExtra("totalIdx",23);
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(currentIdx >= choose - 1){
                    ...
                    Intent intent = new Intent(TestEva.this, TestResult.class);
