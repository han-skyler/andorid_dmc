...
public class TestPer extends AppCompatActivity {

    String Type = "Perception";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int totalIdx = intent.getIntExtra("totalIdx",17);
    ...
    private void updateUI(int choose,String uid) {
        ...
        //updatePic(randomQue[currentIdx]);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(currentIdx >= choose - 1){
                    ...
                    Log.e("점수 : ",Integer.toString(score));
                    Intent intent = new Intent(TestPer.this, TestMood.class);
